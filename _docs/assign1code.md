...
There are several ways to load data into R. For this lab I will _manually_ entire the sample of heights from Chapter 3:

```r
    dat$heights <- c(173.9, 171.7, 182.6, 181.5, 162.1, 174.9, 165.7, 182.2, 171.7, 168.1, 189.9, 175.7, 163.4, 186.3, 169.5, 171.9, 173.9, 172.0, 172.7, 172.0)
```
