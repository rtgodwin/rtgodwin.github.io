...
A typo was corrected in Assignment 3, question 1(b). Changed "Three of the variables from the model in Question 3" to "Three of the variables from the model in part (a)". 
{: .notice--info}
