...
The R package `fee` estimates a "first-exposure effect", its marginal effects, and standard errors. This vignette illustrates `fee` via an artificial data set. Please cite "Identification and estimation of a first-exposure effect in social programs" (Godwin, Simpson and Oguzoglu, 2023) when using this package.

## Load package and data

The `fee` package requires the `oneinfl` package. Load both:
